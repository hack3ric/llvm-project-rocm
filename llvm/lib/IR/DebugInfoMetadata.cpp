...
DIFragment::DIFragment(LLVMContext &C, StorageType Storage, Type *Ty)
...
DIFragment *DIFragment::getImpl(LLVMContext &Context, StorageType Storage,
  ...
  return storeImpl(new (0u, Storage) DIFragment(Context, Storage, Ty), Storage);
}
...
DIExprViewer::DIExprViewer(LLVMContext &C) : C(C) {}
DIExprViewer::DIExprViewer(LLVMContext &C,
                           std::initializer_list<DIOp::Variant> IL)
    : C(C), Elements(IL) {}
DIExprViewer::DIExprViewer(const DIExpr &E)
    : C(E.getContext()), Elements(E.Elements) {}

DIExprBuilder::DIExprBuilder(LLVMContext &C) : DIExprViewer(C) {}
DIExprBuilder::DIExprBuilder(LLVMContext &C,
                             std::initializer_list<DIOp::Variant> IL)
    : DIExprViewer(C, IL) {}
DIExprBuilder::DIExprBuilder(const DIExpr &E) : DIExprViewer(E) {}
